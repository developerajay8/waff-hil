...
export default function FranchiseFAQ() {
  ...
  const faqs = [
    { q: "What is the operational gross margin percentage?", a: "Waffhil setups typically register up to 65-70% gross margins due to centralized bulk supply structures and raw material pricing controls." },
