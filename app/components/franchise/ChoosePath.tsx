  ...
  const models = [
    {
      ...
      desc: "Ideal for hands-on entrepreneurs looking to manage operations completely while utilizing Waffhil's supply line blueprints.",
    ...
    },
    {
      ...
      desc: "Perfect for passive financial partners. You invest your capital, and Waffhil's corporate team handles full operations.",
