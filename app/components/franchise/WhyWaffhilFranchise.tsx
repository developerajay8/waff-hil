...
export default function WhyWaffhilFranchise() {
  ...
  return (
    <section className="w-full py-24 bg-[#fcfdfe] border-t border-[#6e3568]/5 select-none">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          {points.map((pt, idx) => (
            <div key={idx} className="flex flex-col gap-4 p-8 rounded-2xl border border-[#6e3568]/5 bg-[#6e3568]/[0.01]">
              ...
              <p className="text-xs sm:text-sm text-[#6e3568]/70 font-normal leading-relaxed">{pt.desc}</p>
            </div>
          ))}
        </div>
      </div>
