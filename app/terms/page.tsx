...
export default function TermsAndConditionsPage() {
  ...
  const termsSections = [
    ...
    },
    {
      ...
      content: "While our systems maintain strict hardware-accelerated code uptime parameters, Waffhil denies framework liability for third-party map data misalignments, network structural drops, or short-term hosting processing stalls. The online portal platform operates explicitly on an 'As-Is' structural delivery standard."
    }
  ];
